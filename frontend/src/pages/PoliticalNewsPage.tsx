...
export default function PoliticalNewsPage() {
  ...
  const { data: articles, isLoading, isError } = useGetNewsByCategory(NewsCategory.political);
      ...
      <div className="container mx-auto px-4 py-4">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-4">
            ...
            {isError ? (
              ...
              <div className="bg-secondary p-10 text-center">
                ...
                <p className="font-condensed text-lg text-muted-foreground">
                  No political articles available yet.
                </p>
                <p className="text-muted-foreground font-sans text-sm mt-1">
                  Check back soon for the latest political news.
                </p>
              </div>
            ) : (
              <>
          ...
          <aside className="lg:col-span-1">
            <TopStoriesSidebar articles={topStories} title="Top Political Stories" />
          </aside>
        </div>
      </div>
    </main>
